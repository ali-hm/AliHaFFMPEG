...
namespace AliHaFFMPEG.Core
{
    ...
    /// <summary>Runs ffprobe and parses its output.</summary>
    public static class MediaInfoReader
    {
        public static double? GetDurationSeconds(string ffprobePath, string inputFile)
        {
            ...
            return ParseDurationOutput(output);
        }

        public static double? ParseDurationOutput(string output)
        {
            if (output == null)
            {
                return null;
        ...
        public static MediaInfo ParseMediaInfoJson(string json)
        {
